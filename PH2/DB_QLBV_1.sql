...
, SONGAYCONG NUMBER 
, CONSTRAINT CHAMCONG_PK PRIMARY KEY 
  (
    MANV 
  , THANG 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX CHAMCONG_PK ON CHAMCONG (MANV ASC, THANG ASC) 
      LOGGING 
      TABLESPACE USERS 
      PCTFREE 10 
      INITRANS 2 
...
BEGIN 
    ...
    VALUES(:new.MANV,:new.MANV, CURRENT_TIMESTAMP);
END;
/
...
BEGIN
    ...
    LOOP
        ...
        EXECUTE IMMEDIATE ('CREATE USER U_QLBV_' || U_NAME ||' IDENTIFIED BY '||P_WORD);
        EXECUTE IMMEDIATE ('GRANT CONNECT TO U_QLBV_' || U_NAME);  
    END LOOP;
...
BEGIN
    ...
    LOOP
        ...
        EXECUTE IMMEDIATE ('DROP USER U_QLBV_' || U_NAME);
    END LOOP;
    CLOSE C_USERNAME;
END;
/
...
-----BANG CHAM CONG
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('QL001', 5, 31);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('TT001', 2, 28);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('TT002', 12, 30);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('BS001', 3, 15);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('BS002', 8, 29);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('TV001', 7, 31);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('BT001', 10, 30);
INSERT INTO CHAMCONG(MANV, THANG, SONGAYCONG) VALUES ('BT002', 1, 20);
...
/
----------------MANANGE USER, ROLE---------------
/*CREATE ROLE R_QLBV_QUANLY;
grant connect to R_QLBV_QUANLY;

CREATE ROLE R_TIEPTAN;
grant connect to R_QLBV_TIEPTAN;

CREATE ROLE R_BACSI;
grant connect to R_QLBV_BACSI;

CREATE ROLE R_KETOAN;
grant connect to R_QLBV_KETOAN;

CREATE ROLE R_TAIVU;
grant connect to R_QLBV_TAIVU;

CREATE ROLE R_QLBV_BANTHUOC;
grant connect to R_QLBV_BANTHUOC;

/

CREATE ROLE R_QLBV_QLNHANSU;
CREATE ROLE R_QLBV_QLTAIVU;
grant connect to R_QLBV_QLNHANSU, R_QLBV_QLTAIVU;
*/
